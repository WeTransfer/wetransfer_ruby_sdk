module WeTransfer
  ...
  class FutureFile
    ...
    def upload_file(client:, remote_object:, remote_file:)
      ensure_right_file!(remote_file)
      put_io_in_parts(client: client, remote_object: remote_object, remote_file: remote_file)
    end
    ...
    def put_io_in_parts(client:, remote_object:, remote_file:)
